...
public class Insert extends javax.swing.JFrame {
    ...
    private void insertData() {
        ...
        if (tfID.getText().isEmpty() || tfJudul.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "ID dan Judul harus diisi!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            pstmt.setString(4, tfPenerbit.getText());
            pstmt.setInt(5, Integer.parseInt(tfTahun.getText()));
