...
public class Update extends javax.swing.JFrame {
    ...
    private void Button_CancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_CancelActionPerformed
        ...
        try {
            ...
            pstmt.setString(1, tf_Judul_Update.getText().trim());
            pstmt.setString(2, tf_Penulis_Update.getText().trim());
            pstmt.setString(3, tf_Penerbit_Update.getText().trim());
            pstmt.setInt(4, Integer.parseInt(tf_Tahun_Update.getText().trim()));
            pstmt.setString(5, tf_ID_Update.getText().trim());
            ...
            if (rowsAffected > 0) {
                ...
                dispose(); // Tutup window setelah update berhasil
            } else {
                JOptionPane.showMessageDialog(this, 
        ...
        try {
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(this, 
                    ...
                    "Error", 
                    JOptionPane.ERROR_MESSAGE);
                dispose(); // Tutup window jika data tidak ditemukan
            }
